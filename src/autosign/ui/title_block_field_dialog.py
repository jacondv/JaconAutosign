...
class TitleBlockFieldDialog(QDialog):
    def __init__(
        ...
        layout.addWidget(
            QLabel(
                "Mark what this rectangle contains. \"Revision table\" fields should point "
                "at the newest (topmost) row - it stays in the same spot as older revisions "
                "get pushed down below it."
            )
        )
